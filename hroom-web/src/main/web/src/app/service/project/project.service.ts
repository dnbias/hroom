...
export class ProjectService {
  ...
  roomSta: stanze[] = [
    ...
    {
      id: 2, prezzo: 11, nome: "Stanza Bela", stelle: 3.4, tags: [Tag.IDRO], nomeHost: "Enrico", imageUrl: "../../../../assets/StanzePic/foto3.jpeg", favorite: false, luogo: ["Milano"], roomtime: 10,
    },
    {
      id: 1, prezzo: 10, nome: 'ciao', favorite: false, stelle: 4.0, tags: [Tag.APPARTAMENTO, Tag.IDRO,], imageUrl: '/assets/StanzePic/fotox.jpeg', roomtime: 10, luogo: ['Parigi'], nomeHost: 'Enrico'},
    {
      id: 2, prezzo: 15, nome: 'Stanza suprema', favorite: false, stelle: 3.4, tags: [Tag.STANZA, Tag.COLAZIONE], imageUrl: '/assets/StanzePic/foto2.jpeg', roomtime: 10, luogo: ['Milano'], nomeHost: 'Carlo'
    },
    {
      id: 3,
      prezzo: 10,
